...
public class StatTracker 
{
    ...
    public void PrintStats() 
    {
        ...
        db.logHistory(players.get(0).getName(), currentDate, selfShot.get(players.get(0)), turnsSurvived.get(players.get(0)));
        db.logHistory(players.get(1).getName(), currentDate, selfShot.get(players.get(1)), turnsSurvived.get(players.get(1)));
