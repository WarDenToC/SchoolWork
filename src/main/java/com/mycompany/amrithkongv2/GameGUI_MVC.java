...
public class GameGUI_MVC extends JFrame
{
    ...
    public GameGUI_MVC()
    {
        ...
        try
        {
            ...
            revolverStatusLabel = new JLabel("Message: ");
            ...
            //GUI doesn't work well so had to ditch it
    ...
    // hidden button that will help the player if they try to kill themselves a couple of time, at start they are hidden 
    ...
    // end of hidden button toggle
    
    private void styleFunctionButton(JButton button) // a method to make life easier by calling it to style button 
    {
    ...
    public void setPlayerTurn(String playerName) // update the turn so that the player knows who turn it is
    {
    ...
    {
        revolverStatusLabel.setText("Message: " + status);
    }
    ...
    /* used this for testing the gui, chat helped with this
