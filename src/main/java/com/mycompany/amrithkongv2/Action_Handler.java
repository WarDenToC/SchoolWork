...
{
    //This whole entire class has been refactored. At it's core it would be the same but it will be returning a String message 
    ...
    public String reSpin()
    {
        ...
        return "WRRRRRRRRRRRRRRR"; //This is what a revovler sounds like when you spin it
    }
